...
RSpec.describe 'Devise::Mailer' do
  describe 'notify' do
    ...
    it 'shows the default confirmation state' do
      ...
      expect(mail_body).to include('Benvenuto su Chatwoot!')
      expect(mail_body).to include('Conferma il mio account')
      expect(mail_body).not_to include('Invito al workspace')
    end
    ...
    context 'when there is an inviter' do
      ...
      it 'refers to the inviter and their account' do
        ...
        expect(mail_body).to include("#{inviter_val.name}, di #{account.name}, ti ha invitato a provare Chatwoot.")
        expect(mail_body).to include('Conferma il mio account')
    ...
    context 'when user already confirmed' do
      ...
      it 'send instructions with the link to login' do
        ...
        expect(confirmation_body).to include('Il tuo account è pronto')
        expect(confirmation_body).to include('Accedi al mio account')
